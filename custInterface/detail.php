			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc price">Price:</span> IDR <span id="price"><?php echo $price; ?></span></p>
						...
						<p><span class="bold_desc">Total Price:</span> IDR <span id="total_price"><?php echo $price; ?></span></p>
