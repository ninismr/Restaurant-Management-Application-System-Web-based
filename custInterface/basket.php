<?php 
	...
	if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
		...
		$cartOutput = "<h3 style=' text-align: center; font-weight: lighter; padding: 10px 0px; background: #D4E3FF; color: #333;'>Your shopping basket is empty</h3>";
		...
		$cartTotal = '<p class="p_total"><span>Basket Total</span> : IDR <span id="cart-total">'.$cartTotal.'</span></p>';
	...
	<div class="inner_content">
		...
		<div class="contact">
			...
			<div class="left">
				...
				<h3 style="margin-left:120px">CONTACT</h3>
				<p style="margin-left:120px">(021) 12345678, 081234567891</p>
				<p style="margin-left:120px">SEGroup5@example.com</p>
...
<div class="footer_parallax" onclick="remove_class()">
	...
	<div class="on_footer_parallax">
		...
		<p>&copy; <?php echo strftime("%Y", time()); ?> <span>FiveRestaurant</span>. All Rights Reserved</p>
