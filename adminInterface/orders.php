        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #6495ED;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">MENU ORDERS</a>
                </div>
                        ...
                        <div class="card">
							...
							<div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='orders.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #6495ED;' >$i</a>  "  : " <a href='orders.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
