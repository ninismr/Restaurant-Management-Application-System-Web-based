			...
			if($cat != "" && $name != "" && $price != "" && $desc != "" && empty($file) == false) {
				...
				if(in_array($ext[1], $allowed_ext)) {
					...
					if($check->num_rows) {
						...
						$msg = "<p style='color:red; padding: 10px; background: #ffeeee;'>No duplicate menu name allowed, try again!</p>";
						...
						if($insert) {
							...
							if(move_uploaded_file($_FILES['file']['tmp_name'], $image_url)) {
								...
								$msg = "<p style='color:green; padding: 10px; background: #eeffee;'>New menu successfully saved!</p>";
								
							}else{
								
								$msg = "<p style='color:red; padding: 10px; background: #ffeeee;'>Could not insert the new menu, try again!</p>";
...
<head>
	...
	<title>Five Restaurant System</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed" style="background: #6495ED;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">ADD NEW MENU</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Menu Add Form</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="food_add.php" enctype="multipart/form-data">
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333">Menu Name</label>
                                                <input type="text" autofocus name="name" class="form-control" placeholder="Enter menu name" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" id="price" class="form-control" placeholder="Enter menu price" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtarea" class="form-control" placeholder="Enter menu description" name="desc" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="submit" style="background: #4169E1; border: 1px solid #4169E1" value="Save Menu" class="btn btn-info btn-fill pull-right" />
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <?php echo strftime("%Y", time())?> <a href="index.php">FiveRestaurant</a>
                </p>
            </div>
        </footer>
