	...
	if(isset($_GET['delete'])) {
		...
		if($delete != "") {
			...
			if($sql) {
				...
				echo "<script>alert('Operation unsuccessful, try again!')</script>";
...
<head>
	...
	<script>
		...
		function check() {
			...
			return confirm("Are you sure want to delete this menu?");
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2">
                        ...
                        <span class="icon-bar" style="background: #fff;"></span>
                        <span class="icon-bar" style="background: #FAEBD7;"></span>
                    </button>
                    <a class="navbar-brand" href="#" style="color: #fff;">MENU COLLECTION</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='food_list.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #6495ED;' >$i</a>  "  : " <a href='food_list.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
