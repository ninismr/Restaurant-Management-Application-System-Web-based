...
<div class="login_wrapper">
	...
	<div class="login_holder">
		...
		<form method="post" action="index.php">
			...
			<div class="header">
				<h4 style="border-bottom: 1px solid #6495ED;" class="title">Login Form</h4>
			</div>
			...
			<!--<p><a style="color: #6495ED;" href="register.php">No account yet! Click Here to register</a></p>-->
			
			<input type="submit" name="submit" value="Login" class="btn btn-info btn-fill pull-right" style="background: #4169E1; border-color: #4169E1;" />
