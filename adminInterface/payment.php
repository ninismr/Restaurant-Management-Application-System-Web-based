<?php 
	...
	$per_page = 10;
		...
		if($orders->num_rows) {
						...
						$items .= "<tr>
									...
									<td>
										<select onChange=\"change_stat('".$oid."')\" name='status' id='".$oid."' class='form-control'>
											<option value='paid off_$oid' selected>paid off</option>
											<option value='not yet paid off_$oid'>not yet paid off</option>
										</select>
									</td>
									<th></th>
								</tr>";
						...
						$items .= "<tr>
									...
									<td>
										<select onChange=\"change_stat('".$oid."')\" id='".$oid."' name='status' class='form-control'>
											<option value='paid off_$oid' >paid off</option>
											<option value='not yet paid off_$oid' selected>not yet paid off</option>
										</select>
									</td>
									<th></th>
								</tr>";
			...
			$result = "No payment orders available yet";
...
<head>
	...
	<script>
		...
		function check() {
			...
			return confirm("Are you sure want to delete this order?");
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #6495ED;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">PAYMENT ORDERS</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="text-align: center">Payment List</h4>
                            </div>
							...
							<div class="row">
								...
								<div class="col-md-12" >
									...
									<div class="col-md-3" style="text-align: center; background: #4169E1; color: #fff; border-right: 1px solid #fff;">
									
										<h5>ORDER ID</h5>
										
									</div>
									
									<div class="col-md-9" style="background: #4169E1; color: #fff;">
							...
							<div class="content table-responsive table-full-width">
								...
								<p style="padding: 0px 20px;"><?php if($pages >= 1 && $page <= $pages) {
									for($i = 1; $i <= $pages; $i++) {
										echo ($i == $page) ? "<a href='payment.php?page=".$i."' style='margin-left:5px; font-weight: bold; text-decoration: none; color: #6495ED;' >$i</a>  "  : " <a href='payment.php?page=".$i."' class='btn'>$i</a> ";
									}
								} ?></p>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; 2022 <a href="index.php" style="color: #6495ED;">FiveRestaurant</a>
                </p>
            </div>
        </footer>
